...
wget -c https://github.com/apache/flink-kubernetes-operator/archive/refs/tags/release-${FLINKOP_VERSION}.tar.gz -o flink-kubernetes-operator-release-${FLINKOP_VERSION}.tar.gz
