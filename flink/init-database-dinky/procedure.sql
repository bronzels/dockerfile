...
###SEP###
-- SEP之间的第1行以外起头必须有空格，不然连成1行时前行和后行会连在一起出错
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `dlink_flink_document`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `dlink_user`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `dlink_tenant`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `dlink_namespace`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `dlink_role`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `dlink_role_namespace`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `dlink_user_role`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `dlink_user_tenant`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `dlink_udf_template`;
        IF num = 0
        THEN
