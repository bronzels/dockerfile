...
#1.15
#1.17
cp target/flink-connector-starrocks-${STARROCKS_CONNECTOR_VERSION}_flink-${FLINK_SHORT_VERSION}.jar ${PRJ_FLINK_HOME}/starrocksbk/


kubectl delete deployments.apps -n flink cdc-starrocks-test-basic
