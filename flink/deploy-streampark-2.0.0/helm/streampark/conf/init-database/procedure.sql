...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `t_team`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `t_flink_app`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `t_flink_effective`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `t_flink_project`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `t_flink_sql`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `t_menu`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `t_role`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `t_role_menu`;
        IF num = 0
        THEN
...
CREATE PROCEDURE insert_record() 
    BEGIN
        DECLARE num INT;
        SELECT count(*) INTO num FROM `t_setting`;
        IF num = 0
        THEN
